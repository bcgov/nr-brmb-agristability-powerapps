...
export const ALL_COLUMNS: ColumnDef[] = [
  ...
  { key: 'nonPenaltyDeadlineDaysLeft', label: 'Non-Penalty Deadline Days Left', icon: 'number', removable: true },
  { key: 'finalDeadlineDaysDiff', label: 'Final Deadline Days Diff', icon: 'number', removable: true },
  { key: 'lateFinalDeadlineDaysDiff', label: 'Late Final Deadline Days Diff', icon: 'number', removable: true },
...
export const ADV_FIELD_LABELS: Record<string, string> = {
  ...
  lateEnrolmentNoticeSentDate: 'Late Enrolment Notice Sent',
  nonPenaltyDeadlineDaysLeft: 'Non-Penalty Deadline Days Left',
  finalDeadlineDaysDiff: 'Final Deadline Days Diff',
  lateFinalDeadlineDaysDiff: 'Late Final Deadline Days Diff',
...
export const ADV_FIELD_OPTIONS: Record<string, 'choice' | 'text' | 'number'> = {
  ...
  lateEnrolmentNoticeSentDate: 'text',
  nonPenaltyDeadlineDaysLeft: 'number',
  finalDeadlineDaysDiff: 'number',
  lateFinalDeadlineDaysDiff: 'number',
