...
export const ALL_COLUMNS: ColumnDef[] = [
  ...
  { key: 'lateEnrolNoticeDate', label: 'Late EN Notice Sent Date', icon: 'date', removable: true },
  { key: 'enrolmentOptedOutDate', label: 'Enrolment Opted Out Date', icon: 'date', removable: true },
