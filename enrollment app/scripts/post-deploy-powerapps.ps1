...
# Generate src/constants/deployEnvConfig.ts with environment-specific values for the AppSwitcher.
...
Write-Host "  Generated deployEnvConfig.ts (environmentId: $environmentId)" -ForegroundColor Green
